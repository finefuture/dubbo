 ...
 */
package org.apache.dubbo.rpc.protocol.tri.websocket.grpc;
...
public class GrpcWebSocketServerTransportListenerFactory implements WebSocketServerTransportListenerFactory {

    @Override
    public WebSocketTransportListener newInstance(
            H2StreamChannel streamChannel, URL url, FrameworkModel frameworkModel) {
        return new GrpcWebSocketServerTransportListener(streamChannel, url, frameworkModel);
    }
