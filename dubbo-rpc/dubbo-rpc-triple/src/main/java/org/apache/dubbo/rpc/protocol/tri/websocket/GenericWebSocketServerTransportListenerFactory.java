...
@Activate
public class GenericWebSocketServerTransportListenerFactory implements WebSocketServerTransportListenerFactory {

    public static final WebSocketServerTransportListenerFactory INSTANCE =
            new GenericWebSocketServerTransportListenerFactory();

    @Override
    public WebSocketTransportListener newInstance(
            H2StreamChannel streamChannel, URL url, FrameworkModel frameworkModel) {
        return new GenericWebSocketServerTransportListener(streamChannel, url, frameworkModel);
    }
