...
import org.apache.dubbo.rpc.protocol.tri.websocket.GenericWebSocketServerTransportListenerFactory;
...
public class TripleEndpoint extends Endpoint {
    ...
    public void onOpen(Session session, EndpointConfig config) {
        ...
        WebSocketTransportListener webSocketTransportListener =
                GenericWebSocketServerTransportListenerFactory.INSTANCE.newInstance(
