...
public class WebSocketServerUpgradeCodec implements HttpServerUpgradeHandler.UpgradeCodec {
    ...
    private final UpgradeChannelHandlerBuilder upgradeChannelHandlerBuilder;

    public WebSocketServerUpgradeCodec(
            List<Class<? extends ChannelHandler>> shouldRemoveChannelHandlers,
            UpgradeChannelHandlerBuilder upgradeChannelHandlerBuilder) {
        this.shouldRemoveChannelHandlers = shouldRemoveChannelHandlers;
        this.upgradeChannelHandlerBuilder = upgradeChannelHandlerBuilder;
    }
    ...
    public boolean prepareUpgradeResponse(
        ...
        List<ChannelHandler> channelHandlers = upgradeChannelHandlerBuilder.buildChannelHandlers(upgradeRequest);
    ...
    public interface UpgradeChannelHandlerBuilder {

        List<ChannelHandler> buildChannelHandlers(FullHttpRequest upgradeRequest);
    }
}
